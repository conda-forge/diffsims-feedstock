...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/diffsims-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=7125&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/diffsims-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `diffsims` can be installed with:

```
conda install diffsims
```

It is possible to list all of the versions of `diffsims` available on your platform with:
